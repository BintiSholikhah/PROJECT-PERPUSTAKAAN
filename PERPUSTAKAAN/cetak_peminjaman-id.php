...
$id = $_GET['id'];
$no=1;
$mahasiswa = mysqli_query($con, $sql1 = "SELECT peminjaman.id, peminjaman.nama, peminjaman.nim, buku.judul, peminjaman.tanggal_pinjam, peminjaman.max_pengembalian, peminjaman.keterangan, peminjaman.tanggal_dikembalikan, peminjaman.denda FROM peminjaman, buku WHERE peminjaman.id_buku = buku.id and peminjaman.id='$id' ");
